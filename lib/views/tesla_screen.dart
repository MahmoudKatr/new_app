...
class TeslaScreen extends StatefulWidget {
  ...
  @override
  State<TeslaScreen> createState() => _TeslaScreen();
}

class _TeslaScreen extends State<TeslaScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<NewsCubit>(context)
        .fetchData('tesla', from.toString(), to.toString());
  }
  ...
  void selectDateRange(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      BlocProvider.of<NewsCubit>(context)
          .fetchData('tesla', picked.start.toString(), picked.end.toString());
    }
  }
